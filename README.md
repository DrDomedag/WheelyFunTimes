...
### Pipelines
**Backfill** - Loads historical vehicle, weather and calendar data for a desired period of time. The data is downloaded as a mixture of text and protobuf files, which are handled, cleaned, collated and uploaded into separate feature groups in Hopsworks. The library developed as part of the KoDa project, which had become obsolete, was modified to support the latest version of the API.

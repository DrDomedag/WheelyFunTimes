...
def purge_project(proj):
    ...
    delete_feature_groups(fs, "triplicate")
    delete_feature_groups(fs, "vehicle_future")
    delete_feature_groups(fs, "predictions")

    # Delete all Models
    delete_models(mr, "bus_occupancy_xgboost_model")
